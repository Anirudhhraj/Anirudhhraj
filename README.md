...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=MS+in+Information+Systems+%40+Northeastern;Building+ML+Models+%2B+Cloud+Infrastructure;Data+Engineer+%7C+MLOps+%7C+ML+Engineer)](https://git.io/typing-svg)

<img src="https://komarev.com/ghpvc/?username=Anirudhhraj&label=Profile%20views&color=0e75b6&style=flat" alt="profile views" />
...
class AnirudhRaj:
    def __init__(self):
        ...
        self.education = {
            "current": "MS Information Systems @ Northeastern (GPA: 3.9)",
            "completed": "BE Information Science @ BMS College of Engineering"
        }
        self.seeking = ["Data Engineer", "MLOps Engineer", "ML Engineer"]
        self.status = "Open to Full-Time Roles (OPT, H1B Sponsorship)"
        
    def recent_achievements(self):
        return {
            "ml_model": "Built 70M-parameter text diffusion model from scratch",
            "cloud": "Deployed 78 AWS resources with zero-downtime CI/CD",
            "research": "Comparative study: Transformers vs Diffusion (87% loss reduction)",
            "finance": "Trading bot: 2.17 Sharpe ratio, 91% correlation"
        }
        
    def strongest_skills(self):
        return ["PyTorch", "TensorFlow", "AWS", "Terraform", "Python"]
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/anirudhraj2000/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:raj.anir@northeastern.edu)
[![Portfolio](https://img.shields.io/badge/Portfolio-000000?style=for-the-badge&logo=About.me&logoColor=white)](https://github.com/Anirudhhraj)

**📍 Boston, MA** | **💼 Seeking Full-Time Roles** | **🎓 Graduating May 2026**
...
what_i_build:
  - name: "ML Models from Scratch"
    example: "70M-param Diffusion U-Net + Transformer"
    impact: "87% loss reduction, 18% token accuracy"
    
  - name: "Production Cloud Infrastructure"
    example: "78 AWS resources, zero-downtime CI/CD"
    impact: "Sub-100ms response, 85% latency reduction"
